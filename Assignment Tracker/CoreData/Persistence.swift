...
class StorageProvider {
    ...
    init() {
        persistentContainer = NSPersistentContainer(name: "Assignment_Tracker")
        
        let storeURL = URL.storeURL(for: "group.com.benk.assytrack", databaseName: "Assignment_Tracker")
...
struct PersistenceController {
    ...
    let container: NSPersistentContainer = {
        let pc = NSPersistentContainer(name: "Assignment_Tracker")
            let storeURL = URL.storeURL(for: "group.com.benk.assytrack", databaseName: "Assignment_Tracker")
            let storeDescription = NSPersistentStoreDescription(url: storeURL)
